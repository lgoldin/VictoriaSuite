...
namespace Victoria.UI.SharedWPF
{
    /// <summary>
    ...
    public static class SmartDispatcher
    {
        ...
        private static void RequireInstance()
        {
            if (_designer == null)
            {
                _designer = DesignerProperties.GetIsInDesignMode(new DependencyObject()); //DesignerProperties.IsInDesignTool;
            }
            ...
            try
            {
                _instance = Application.Current.Dispatcher; //!!!!VER QUE ONDA
            }
            catch (Exception e)
            {
